...
def classify_requirement(requirement):
    response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "Eres un experto en clasificación de requisitos.",
            },
            {
                "role": "user",
                "content": f"Clasifica el siguiente requisito únicamente como 'RF' (Requisito Funcional), 'RNF' (Requisito No Funcional) o 'No Clasificado': {requirement}. Responde solo con una de esas opciones y nada más.",
            },
        ],
